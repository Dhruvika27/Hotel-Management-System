...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        self.root.geometry("1600x880+0+0")
...
#===============title==============
        ...
        report_btn = Button(btn_frame, text="FEEDBACK", width=22,command=self.feedback, font=("time new roman", 14, "bold"), bg="black",fg="gold", bd=0, cursor="hand1")
        report_btn.grid(row=3, column=0,pady=1)

        logout_btn = Button(btn_frame, text="LOGOUT",command=self.logout, width=22, font=("time new roman", 14, "bold"), bg="black",fg="gold", bd=0, cursor="hand1")
