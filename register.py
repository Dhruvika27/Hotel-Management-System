...
class Register:
    def __init__(self,root):
        ...
        #====================== bg image============
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Dell\Desktop\hotel-management\image\0-3450_3d-nature-wallpaper-hd-1080p-free-download-new.jpg")
        ...
        self.bg1 = ImageTk.PhotoImage(
            file=r"C:\Users\Dell\Desktop\hotel-management\image\2525.jpg")
        ...
        img=Image.open(r"C:\Users\Dell\Desktop\hotel-management\image\register-now-button1.jpg")
        img=img.resize((200,50),Image.LANCZOS)
        self.photoimage=ImageTk.PhotoImage(img)
        b1=Button(frame,image=self.photoimage,command=self.register_data,borderwidth=0,cursor="hand2")
        b1.place(x=10,y=420,width=200)

        img1 = Image.open(r"C:\Users\Dell\Desktop\hotel-management\image\loginpng.png")
